 ...
 */
@RestController
@RequestMapping("/public/api/interest")
public class InterestService {
    ...
    public ResponseEntity<Iterable<Interest>> list() {
        HttpHeaders headers = new HttpHeaders();
        return new ResponseEntity<>(repository.findAll(), headers, HttpStatus.OK);
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<Interest> list(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<Interest> create(@RequestBody Interest interest) {
        HttpHeaders headers = new HttpHeaders();
        return new ResponseEntity<>(repository.save(interest), headers, HttpStatus.OK);
    }
}
